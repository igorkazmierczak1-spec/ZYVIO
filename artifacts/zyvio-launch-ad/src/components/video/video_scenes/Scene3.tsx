...
export function Scene3() {
  const steps = [
    { text: "AI-POWERED IDEAS", color: "text-[var(--color-cyan)]", bg: "bg-[var(--color-ink)]" },
    { text: "EARN XP", color: "text-[var(--color-lime)]", bg: "bg-[var(--color-ink)]" },
    { text: "LEVEL UP", color: "text-[var(--color-coral)]", bg: "bg-[var(--color-ink)]" },
  ];
