...
export default function PremiumScreen() {
  ...
  return <AppScreen><Header eyebrow="VYBE / MEMBERSHIP" title="Wybierz swój plan." subtitle="Więcej limitów, więcej możliwości i pełny dostęp do aktywnych funkcji Premium." right={<Text onPress={() => router.back()} style={{ color: colors.primary, fontFamily: 'Inter_700Bold', marginTop: 8 }}>Wróć</Text>} />
