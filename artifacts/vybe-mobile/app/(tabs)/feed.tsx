...
export default function FeedScreen() {
  const colors = useColors(); const [body, setBody] = useState(''); const [attachment, setAttachment] = useState<MediaAttachment | null>(null); const [filter, setFilter] = useState<'for-you' | 'following' | 'trending'>('for-you');
