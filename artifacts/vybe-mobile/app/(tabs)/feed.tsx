...
export default function FeedScreen() {
  ...
  return <AppScreen refreshing={feed.isFetching} onRefresh={() => void feed.refetch()}>
    <Header eyebrow="VYBE / SOCIAL" title="Twój feed." subtitle="Odkrywaj twórców, dziel się energią i buduj swój VYBE." right={<IconButton icon="send" label="Wiadomości" onPress={() => router.push('/messages')} />} />
